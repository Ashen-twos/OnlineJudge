...
from ..views.oj import SubmissionAPI, SubmissionListAPI, ContestSubmissionListAPI, SubmissionExistsAPI, SubmissionExternalAPI
...
urlpatterns = [
    ...
    url(r"^submission_external/?$", SubmissionExternalAPI.as_view(), name="submission_external_api"),
]
